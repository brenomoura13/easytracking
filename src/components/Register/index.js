        ...
        <div className="mr-auto ml-auto w-full">
          ...
          <div className="w-full max-w-md mr-auto ml-auto mt-4">
            <div className="rounded-md px-8 py-8 mb-4 ml-auto mr-auto">
              <div className="mb-4">
                <label className="block slate-900 text-sm font-medium mb-2" htmlFor="username">E-mail</label>
              ...
              <div className="mb-6">
                <label className="block slate-900 text-sm font-medium mb-2" htmlFor="username">Senha</label>
              ...
              {Object.values(providers).map((provider) => (
                ...
                font-semibold text-slate-600 text-sm py-1 text-center rounded text-center w-full
                focus:outline-none hover:border-violet-600 transition-all duration-200">
                  {(() => {
                    switch (provider.id) {
                      case 'google':
                      return (
